...
return [
    ...
    'channels' => [
        ...
        // Laravel Cloud streams logs over a Unix socket via this channel.
        'laravel-cloud-socket' => [
            'driver' => 'monolog',
            'level' => env('LOG_LEVEL', 'debug'),
            'handler' => SyslogUdpHandler::class,
            'handler_with' => [
                'host' => env('LOG_LARAVEL_CLOUD_SOCKET_HOST', '127.0.0.1'),
                'port' => env('LOG_LARAVEL_CLOUD_SOCKET_PORT', 9999),
            ],
